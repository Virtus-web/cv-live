export const dataExperiences = [
    {
        ...
        text: `Développement de plusieurs projets personnels et professionnels dans le cadre de ma formation`,
        missions: [
            {
                id: 1,
                title: "Site de mariage intégrant une API et déployé via GitHhub, Netlify et Heroku",
